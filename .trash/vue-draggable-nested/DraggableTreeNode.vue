<script>
import * as hp from './plugins/helper-js'
import * as th from './plugins/tree-helper'
import draggableHelper from './plugins/draggable-helper.js'
import TreeNode from './TreeNode.vue'
import autoMoveDragPlaceHolder, { isNodeDraggable, isNodeDroppable } from './autoMoveDragPlaceHolder'
import * as vf from './plugins/vue-functions'
